...
bool compareDistance(RouteModel::Node *a, RouteModel::Node *b){
    return (a->h_value + a->g_value) > (b->h_value + b->g_value);
}

RouteModel::Node *RoutePlanner::NextNode() {
    std::sort(RoutePlanner::open_list.begin(), RoutePlanner::open_list.end(), compareDistance);
    RouteModel::Node *node = RoutePlanner::open_list.back();
